...
const englishSkillsCopy = {
  inUse: {
    ...
    boardColumns: {
      ...
      single: "One harness only",
      selective: "Selective",
      enabled: "Enabled everywhere",
    },
    gridCategories: {
      coding: "Coding",
      docs: "Docs",
  ...
  scan: {
    ...
    loadingHarnesses: "Loading harnesses…",
    noHarnesses: "No scannable harness",
    noHarnessesHint: "Enable a supported harness (Claude, Codex, Copilot, or Cursor) in Settings and install its CLI.",
    configNav: "Scan",
    configTitle: "Scan settings",
    configSubtitle: "Choose which enabled harness CLI runs skill security scans.",
    configHarnessHeading: "Default scan harness",
    configHarnessHint: "Scans use the harness command-line tool on your machine.",
    runScansLink: "Run scans on Skills → In use → Scan view",
    harnessUnavailableCli: "CLI not installed",
    harnessUnavailableNotScannable: "Not supported for scanning",
    ...
    view: {
      ...
      rescanFor: (name: string) => `Re-scan ${name}`,
    ...
    result: {
      ...
      harnessScanner: "Harness scanner",
      harnessUsed: "Scanned with",
      llmModel: "LLM model",
...
export const skillsCopy = {
  ...
  "zh-CN": {
    ...
    scan: {
      harnessLabel: "扫描使用",
      harnessAria: "选择用于安全扫描的 harness",
      loadingHarnesses: "正在加载 harness…",
      noHarnesses: "无可扫描 harness",
      noHarnessesHint: "请在设置中启用支持的 harness（Claude、Codex、Copilot 或 Cursor），并安装对应 CLI。",
      configNav: "扫描",
      configTitle: "扫描设置",
      configSubtitle: "选择用于运行 Skill 安全扫描的已启用 harness CLI。",
      configHarnessHeading: "默认扫描 harness",
      configHarnessHint: "扫描会使用本机上的 harness 命令行工具。",
      runScansLink: "在 Skill → 使用中 → 扫描视图运行扫描",
      harnessUnavailableCli: "未安装 CLI",
      harnessUnavailableNotScannable: "不支持扫描",
      ...
      view: {
        ...
        selectHarnessAria: "请在上方选择 harness 后再扫描",
        scanning: "扫描中",
        viewResult: "查看结果",
        rescan: "重新扫描",
        retry: "重试",
        ...
        rescanFor: (name: string) => `重新扫描 ${name}`,
