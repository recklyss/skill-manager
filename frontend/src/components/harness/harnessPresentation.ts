...
import deepseekLogo from "../../assets/harness-logos/deepseek-logo.svg";
...
export type HarnessLogoKey = "claude" | "codex" | "copilot" | "cursor" | "deepseek" | "hermes" | "opencode" | "openclaw" | "pi";
