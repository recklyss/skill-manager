...
![总览仪表盘与主题选择器](./assets/change-theme.png)

### 使用中的 Skill

以网格、看板或矩阵视图浏览已采用的 Skill。按名称、标签或描述搜索，然后按 harness 或全局启用/停用。深色模式适合长时间审阅。

![深色主题下的使用中 Skill 网格视图](./assets/dark-theme-and-different-view-of-skills.png)
...
![将 harness 中的 Skill 添加到 Skill Manager](./assets/add-to-skill-manager.png)
...
![Skill 扫描结果与风险发现项](./assets/scan-skill-risks.png)
...
![使用中的 MCP 服务器](./assets/mcp-in-use.png)
